...
For interactive commands, use [bubbletea](https://pkg.go.dev/github.com/charmbracelet/bubbletea) with [bubbles](https://github.com/charmbracelet/bubbles) component library. Refer to full source code and examples in `references/vendor/`.
