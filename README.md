...
- When terminal height has spare rows, `bb fix` keeps the primary panel anchored at the top and keeps footer help sticky at the bottom (using only middle spacer rows when needed).
